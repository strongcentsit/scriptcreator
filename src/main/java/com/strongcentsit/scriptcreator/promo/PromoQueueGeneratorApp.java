...
/**
 * Entry point for the Promo Queue Generator: reads source/target product
 * lists from Excel and generates SQL that enqueues a promotion job
 * (steps and sub-steps) into the {@code pp_promo_queue} workflow tables.
 */
public class PromoQueueGeneratorApp {
